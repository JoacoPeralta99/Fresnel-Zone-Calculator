...
while True:
    ...
    if event == sg.WIN_CLOSED or event == "Salir":
        ...
        try:
            ...
            if zona_fresnel < 1:    # i la zona de Fresnel es menor a 1, significa que está prácticamente obstruida.
                explicacion = "La Zona de Fresnel está obstruida. Posible interferencia."          
